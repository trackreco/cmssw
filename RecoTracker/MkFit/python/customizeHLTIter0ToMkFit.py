...
def customizeHLTIter0ToMkFitRelaxedHP(process):
...
def customizeHLTIter0ToMkFitRelaxedHPMaxClusterSize4(process):
    ...
    process.hltSiStripRawToClustersFacility.onDemand = False
    process.hltSiStripRawToClustersFacility.Clusterizer.MaxClusterSize = 4
...
def customizeHLTIter0ToMkFitMaxCand3RelaxedHP(process):
...
def customizeHLTIter0ToMkFitMaxCand3RelaxedHPMaxClusterSize4(process):
...
def customizeHLTSiStripClusterizerOnDemandFalseMaxClusterSize4(process):
...
def modifyOutputModule(process, filename="output.root"):
