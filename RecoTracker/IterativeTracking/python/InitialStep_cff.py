...
from Configuration.Eras.Modifier_trackingMkFitProd_cff import trackingMkFitProd
...
trackingMkFitProd.toReplaceWith(initialStepTrackCandidates, mkFitOutputConverter_cfi.mkFitOutputConverter.clone(
    seeds = 'initialStepSeeds',
...
_InitialStepTask_trackingMkFit = _InitialStepTask_trackingMkFitCommon.copy()
...
trackingMkFitProd.toReplaceWith(InitialStepTask, _InitialStepTask_trackingMkFit)
