...
mkFitSiPhase2Hits = mkFitSiStripHitConverter_cfi.mkFitSiStripHitConverter.clone(isPhase2=cms.bool(True))
...
_InitialStepTask_trackingMkFitCommon.add(siPhase2RecHits, mkFitSiPixelHits, mkFitSiPhase2Hits, mkFitEventOfHits, mkFitGeometryESProducer)
...
(trackingMkFitCommon & trackingPhase2PU140).toModify(mkFitEventOfHits, stripHits=cms.InputTag('mkFitSiPhase2Hits'), isPhase2=cms.bool(True))
(trackingMkFitInitialStep & trackingPhase2PU140).toModify(initialStepTrackCandidatesMkFit, stripHits=cms.InputTag('mkFitSiPhase2Hits'), isPhase2=cms.bool(True))
(trackingMkFitInitialStep & trackingPhase2PU140).toModify(initialStepTrackCandidates, mkFitStripHits=cms.InputTag('mkFitSiPhase2Hits'), isPhase2=cms.bool(True))
...
(trackingMkFitInitialStep & trackingPhase2PU140).toModify(initialStepTrackCandidatesMkFitSeeds, isPhase2=cms.bool(True))
