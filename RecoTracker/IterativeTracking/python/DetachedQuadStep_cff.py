...
trackingMkFit.toReplaceWith(detachedQuadStepTrackCandidates, mkFitOutputConverter_cfi.mkFitOutputConverter.clone(
    seeds = 'detachedQuadStepSeeds',
...
trackingMkFit.toReplaceWith(DetachedQuadStepTask, _DetachedQuadStepTask_trackingMkFit)
