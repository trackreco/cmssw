...
trackingMkFitProd.toReplaceWith(highPtTripletStepTrackCandidates, mkFitOutputConverter_cfi.mkFitOutputConverter.clone(
    seeds = 'highPtTripletStepSeeds',
...
trackingMkFitProd.toReplaceWith(HighPtTripletStepTask, _HighPtTripletStepTask_trackingMkFit)
