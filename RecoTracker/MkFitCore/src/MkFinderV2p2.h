...
namespace mkfit {
  ...
  class MkFinderV2p2 : public MkBase {
    ...
    struct PrimTCandRep {
      ...
      TrackCand& tcand() { return mp_ccrep->m_ccand[m_origin_tcand_index]; }
    ...
    public:
      ...
      iterator begin() const { return iterator(ccand(m_begin)); }
      iterator end() const { return iterator(ccand(m_end)); }
