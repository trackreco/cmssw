 ...
 */
    ...
    class AddOp {
    public:
      static inline T apply(const T& lhs, const T& rhs) { return lhs + rhs; }
    };
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D>
    inline VecExpr<BinaryOp<AddOp<T>, SVector<T, D>, SVector<T, D>, T>, T, D> operator+(const SVector<T, D>& lhs,
    ...
    inline VecExpr<BinaryOp<AddOp<T>, VecExpr<A, T, D>, SVector<T, D>, T>, T, D> operator+(const VecExpr<A, T, D>& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<AddOp<T>, SVector<T, D>, VecExpr<A, T, D>, T>, T, D> operator+(
        const SVector<T, D>& lhs, const VecExpr<A, T, D>& rhs) {
    ...
    inline VecExpr<BinaryOp<AddOp<T>, VecExpr<A, T, D>, VecExpr<B, T, D>, T>, T, D> operator+(
        const VecExpr<A, T, D>& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<AddOp<T>, SVector<T, D>, Constant<A>, T>, T, D> operator+(const SVector<T, D>& lhs,
                                                                                           const A& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<AddOp<T>, Constant<A>, SVector<T, D>, T>, T, D> operator+(const A& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<AddOp<T>, VecExpr<B, T, D>, Constant<A>, T>, T, D> operator+(
        const VecExpr<B, T, D>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<AddOp<T>, Constant<A>, VecExpr<B, T, D>, T>, T, D> operator+(
        const A& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    inline Expr<BinaryOp<AddOp<T>, SMatrix<T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
    ...
    operator+(const SMatrix<T, D, D2, R1>& lhs, const SMatrix<T, D, D2, R2>& rhs) {
      ...
      return Expr<AddOpBinOp, T, D, D2, typename AddPolicy<T, D, D2, R1, R2>::RepType>(
          AddOpBinOp(AddOp<T>(), lhs, rhs));
    }
    ...
    inline Expr<BinaryOp<AddOp<T>, Expr<A, T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<AddOp<T>, SMatrix<T, D, D2, R1>, Expr<A, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    inline Expr<BinaryOp<AddOp<T>, Expr<A, T, D, D2, R1>, Expr<B, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
...
*/
    ...
    inline Expr<BinaryOpCopyR<AddOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator+(
        const SMatrix<T, D, D2, R>& lhs, const A& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<AddOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T>, T, D, D2, R> operator+(
        const A& lhs, const SMatrix<T, D, D2, R>& rhs) {
      typedef BinaryOpCopyL<AddOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T> AddOpBinOp;

      return Expr<AddOpBinOp, T, D, D2, R>(AddOpBinOp(AddOp<T>(), Constant<A>(lhs), rhs));
    }
    ...
    inline Expr<BinaryOpCopyR<AddOp<T>, Expr<B, T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator+(
        const Expr<B, T, D, D2, R>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<AddOp<T>, Constant<A>, Expr<B, T, D, D2, R>, T>, T, D, D2, R> operator+(
        const A& lhs, const Expr<B, T, D, D2, R>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D>
    inline VecExpr<BinaryOp<MinOp<T>, SVector<T, D>, SVector<T, D>, T>, T, D> operator-(const SVector<T, D>& lhs,
                                                                                        const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<MinOp<T>, VecExpr<A, T, D>, SVector<T, D>, T>, T, D> operator-(const VecExpr<A, T, D>& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<MinOp<T>, SVector<T, D>, VecExpr<A, T, D>, T>, T, D> operator-(
        const SVector<T, D>& lhs, const VecExpr<A, T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOp<MinOp<T>, VecExpr<A, T, D>, VecExpr<B, T, D>, T>, T, D> operator-(
        const VecExpr<A, T, D>& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<MinOp<T>, SVector<T, D>, Constant<A>, T>, T, D> operator-(const SVector<T, D>& lhs,
                                                                                           const A& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<MinOp<T>, Constant<A>, SVector<T, D>, T>, T, D> operator-(const A& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<MinOp<T>, VecExpr<B, T, D>, Constant<A>, T>, T, D> operator-(
        const VecExpr<B, T, D>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<MinOp<T>, Constant<A>, VecExpr<B, T, D>, T>, T, D> operator-(
        const A& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MinOp<T>, SMatrix<T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    operator-(const SMatrix<T, D, D2, R1>& lhs, const SMatrix<T, D, D2, R2>& rhs) {
      ...
      return Expr<MinOpBinOp, T, D, D2, typename AddPolicy<T, D, D2, R1, R2>::RepType>(
          MinOpBinOp(MinOp<T>(), lhs, rhs));
    }
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MinOp<T>, Expr<A, T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MinOp<T>, SMatrix<T, D, D2, R1>, Expr<A, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MinOp<T>, Expr<A, T, D, D2, R1>, Expr<B, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<MinOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator-(
        const SMatrix<T, D, D2, R>& lhs, const A& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<MinOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T>, T, D, D2, R> operator-(
        const A& lhs, const SMatrix<T, D, D2, R>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<MinOp<T>, Expr<B, T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator-(
        const Expr<B, T, D, D2, R>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<MinOp<T>, Constant<A>, Expr<B, T, D, D2, R>, T>, T, D, D2, R> operator-(
        const A& lhs, const Expr<B, T, D, D2, R>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D>
    inline VecExpr<BinaryOp<MulOp<T>, SVector<T, D>, SVector<T, D>, T>, T, D> operator*(const SVector<T, D>& lhs,
                                                                                        const SVector<T, D>& rhs) {
    ...
    // }
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<MulOp<T>, Expr<A, T, D>, SVector<T, D>, T>, T, D> operator*(const VecExpr<A, T, D>& lhs,
                                                                                        const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<MulOp<T>, SVector<T, D>, VecExpr<A, T, D>, T>, T, D> operator*(
        const SVector<T, D>& lhs, const VecExpr<A, T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOp<MulOp<T>, VecExpr<A, T, D>, VecExpr<B, T, D>, T>, T, D> operator*(
        const VecExpr<A, T, D>& lhs, const VecExpr<B, T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<MulOp<T>, SVector<T, D>, Constant<A>, T>, T, D> operator*(const SVector<T, D>& lhs,
                                                                                           const A& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<MulOp<T>, Constant<A>, SVector<T, D>, T>, T, D> operator*(const A& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<MulOp<T>, VecExpr<B, T, D>, Constant<A>, T>, T, D> operator*(
        const VecExpr<B, T, D>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<MulOp<T>, Constant<A>, VecExpr<B, T, D>, T>, T, D> operator*(
        const A& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MulOp<T>, SMatrix<T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    Times(const SMatrix<T, D, D2, R1>& lhs, const SMatrix<T, D, D2, R2>& rhs) {
      ...
      return Expr<MulOpBinOp, T, D, D2, typename AddPolicy<T, D, D2, R1, R2>::RepType>(
          MulOpBinOp(MulOp<T>(), lhs, rhs));
    }
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MulOp<T>, Expr<A, T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MulOp<T>, SMatrix<T, D, D2, R1>, Expr<A, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<MulOp<T>, Expr<A, T, D, D2, R1>, Expr<B, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
...
*/
    ...
    //=============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<MulOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator*(
        const SMatrix<T, D, D2, R>& lhs, const A& rhs) {
      typedef BinaryOpCopyR<MulOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T> MulOpBinOp;

      return Expr<MulOpBinOp, T, D, D2, R>(MulOpBinOp(MulOp<T>(), lhs, Constant<A>(rhs)));
    }
...
*/
    ...
    //=============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<MulOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T>, T, D, D2, R> operator*(
        const A& lhs, const SMatrix<T, D, D2, R>& rhs) {
      typedef BinaryOpCopyL<MulOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T> MulOpBinOp;

      return Expr<MulOpBinOp, T, D, D2, R>(MulOpBinOp(MulOp<T>(), Constant<A>(lhs), rhs));
    }
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<MulOp<T>, Expr<B, T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator*(
        const Expr<B, T, D, D2, R>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<MulOp<T>, Constant<A>, Expr<B, T, D, D2, R>, T>, T, D, D2, R> operator*(
        const A& lhs, const Expr<B, T, D, D2, R>& rhs) {
 ...
 */
    ...
    //==============================================================================
    template <class T, unsigned int D>
    inline VecExpr<BinaryOp<DivOp<T>, SVector<T, D>, SVector<T, D>, T>, T, D> operator/(const SVector<T, D>& lhs,
                                                                                        const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<DivOp<T>, VecExpr<A, T, D>, SVector<T, D>, T>, T, D> operator/(const VecExpr<A, T, D>& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOp<DivOp<T>, SVector<T, D>, VecExpr<A, T, D>, T>, T, D> operator/(
        const SVector<T, D>& lhs, const VecExpr<A, T, D>& rhs) {
    ...
    //=============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOp<DivOp<T>, VecExpr<A, T, D>, VecExpr<B, T, D>, T>, T, D> operator/(
        const VecExpr<A, T, D>& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<DivOp<T>, SVector<T, D>, Constant<A>, T>, T, D> operator/(const SVector<T, D>& lhs,
                                                                                           const A& rhs) {
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<DivOp<T>, Constant<A>, SVector<T, D>, T>, T, D> operator/(const A& lhs,
                                                                                           const SVector<T, D>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyR<DivOp<T>, VecExpr<B, T, D>, Constant<A>, T>, T, D> operator/(
        const VecExpr<B, T, D>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D>
    inline VecExpr<BinaryOpCopyL<DivOp<T>, Constant<A>, VecExpr<B, T, D>, T>, T, D> operator/(
        const A& lhs, const VecExpr<B, T, D>& rhs) {
...
*/
    ...
    //==============================================================================
    template <class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<DivOp<T>, SMatrix<T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    Div(const SMatrix<T, D, D2, R1>& lhs, const SMatrix<T, D, D2, R2>& rhs) {
      ...
      return Expr<DivOpBinOp, T, D, D2, typename AddPolicy<T, D, D2, R1, R2>::RepType>(
          DivOpBinOp(DivOp<T>(), lhs, rhs));
    }
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<DivOp<T>, Expr<A, T, D, D2, R1>, SMatrix<T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<DivOp<T>, SMatrix<T, D, D2, R1>, Expr<A, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R1, class R2>
    inline Expr<BinaryOp<DivOp<T>, Expr<A, T, D, D2, R1>, Expr<B, T, D, D2, R2>, T>,
                T,
                D,
                D2,
                typename AddPolicy<T, D, D2, R1, R2>::RepType>
...
*/
    ...
    //=============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<DivOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator/(
        const SMatrix<T, D, D2, R>& lhs, const A& rhs) {
      typedef BinaryOpCopyR<DivOp<T>, SMatrix<T, D, D2, R>, Constant<A>, T> DivOpBinOp;

      return Expr<DivOpBinOp, T, D, D2, R>(DivOpBinOp(DivOp<T>(), lhs, Constant<A>(rhs)));
    }
...
*/
    ...
    //==============================================================================
    template <class A, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<DivOp<T>, Constant<A>, SMatrix<T, D, D2, R>, T>, T, D, D2, R> operator/(
        const A& lhs, const SMatrix<T, D, D2, R>& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyR<DivOp<T>, Expr<B, T, D, D2, R>, Constant<A>, T>, T, D, D2, R> operator/(
        const Expr<B, T, D, D2, R>& lhs, const A& rhs) {
    ...
    //==============================================================================
    template <class A, class B, class T, unsigned int D, unsigned int D2, class R>
    inline Expr<BinaryOpCopyL<DivOp<T>, Constant<A>, Expr<B, T, D, D2, R>, T>, T, D, D2, R> operator/(
        const A& lhs, const Expr<B, T, D, D2, R>& rhs) {
