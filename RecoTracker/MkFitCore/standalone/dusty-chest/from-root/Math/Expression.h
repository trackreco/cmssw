...
*/
    ...
    public:
      ...
      ///
      VecExpr(const ExprType& rhs) : rhs_(rhs) {}

      ///
      ~VecExpr() {}

      ///
      inline T apply(unsigned int i) const { return rhs_.apply(i); }

      inline T operator()(unsigned int i) const { return rhs_.apply(i); }
...
*/
    ...
    public:
      ...
      ///
      Expr(const ExprType& rhs) : rhs_(rhs) {}
      ...
      ///
      inline T apply(unsigned int i) const { return rhs_.apply(i); }
      inline T operator()(unsigned int i, unsigned j) const { return rhs_(i, j); }
...
*/
    ...
    public:
      ///
      BinaryOp(Operator /* op */, const LHS& lhs, const RHS& rhs) : lhs_(lhs), rhs_(rhs) {}

      ///
      ~BinaryOp() {}

      ///
      inline T apply(unsigned int i) const { return Operator::apply(lhs_.apply(i), rhs_.apply(i)); }
      inline T operator()(unsigned int i, unsigned int j) const { return Operator::apply(lhs_(i, j), rhs_(i, j)); }
...
*/
    ...
    public:
      ///
      BinaryOpCopyL(Operator /* op */, const LHS& lhs, const RHS& rhs) : lhs_(lhs), rhs_(rhs) {}
...
*/
    ...
    public:
      ///
      BinaryOpCopyR(Operator /* op */, const LHS& lhs, const RHS& rhs) : lhs_(lhs), rhs_(rhs) {}
...
*/
    ...
    public:
      ///
      UnaryOp(Operator /* op */, const RHS& rhs) : rhs_(rhs) {}

      ///
      ~UnaryOp() {}

      ///
      inline T apply(unsigned int i) const { return Operator::apply(rhs_.apply(i)); }
      inline T operator()(unsigned int i, unsigned int j) const { return Operator::apply(rhs_(i, j)); }
