 ...
 */
    ...
    */
      template <class M>
      CholeskyDecomp(const M& m) : fL(), fOk(false) {
    ...
    */
      template <typename G>
      CholeskyDecomp(G* m) : fL(), fOk(false) {
        using CholeskyDecompHelpers::_decomposer;
    ...
    namespace CholeskyDecompHelpers {
      ...
      struct _inverter<F, 6, M> {
        ...
        inline void operator()(M& dst, const F* src) const {
          ...
          const F li41 = (-src[1] * src[4] * src[8] * src[2] * src[5] + src[1] * src[7] * src[2] +
                          src[3] * src[8] * src[5] - src[6]) *
                         src[0] * src[9];
          ...
          const F li51 = (src[1] * src[4] * src[8] * src[13] * src[2] * src[5] * src[9] -
                          src[13] * src[8] * src[3] * src[9] * src[5] - src[12] * src[4] * src[1] * src[2] * src[5] -
                          src[13] * src[7] * src[1] * src[9] * src[2] + src[11] * src[1] * src[2] +
                          src[12] * src[3] * src[5] + src[13] * src[6] * src[9] - src[10]) *
                         src[0] * src[14];
          ...
          const F li62 = (src[4] * src[8] * src[13] * src[19] * src[5] * src[9] * src[14] -
                         ...
                         src[2] * src[20];
          const F li61 =
              (-src[19] * src[13] * src[8] * src[4] * src[1] * src[2] * src[5] * src[9] * src[14] +
