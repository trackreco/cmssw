...
#pragma omp simd
      ...
      */
      static void Evaluate(SMatrix<T, D1, D2, MatRepSym<T, D1> >& lhs,
        ...
        // create a temporary object to store result
          ...
          // copy now the temp object
          for (unsigned int i = 0; i < MatRepSym<T, D1>::kSize; ++i)
   ...
   */
    ...
    struct PlaceMatrix {
      static void Evaluate(SMatrix<T, D1, D2, R1>& lhs,
    ...
    template <class T, unsigned int D1, unsigned int D2, unsigned int D3, unsigned int D4>
    ...
    */
    ...
    struct AssignItr {
      ...
      static void Evaluate(
          SMatrix<T, D1, D2, R>& lhs, Iterator begin, Iterator end, bool triang, bool lower, bool check = true) {
