...
(hltTrackingMkFitHighPtTripletStep & trackingLST).toReplaceWith(hltHighPtTripletStepTrackCandidatespLSTCLST,_hltHighPtTripletStepTrackCandidatespLSTCLSTMkFit)
